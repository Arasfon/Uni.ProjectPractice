...
def tabulate(x_min, x_max, x_step, y=1, a=1, b=1):
    ...
    document.add_paragraph(
        ...
        + "другой для кусочно-заданной функции. В модуле кусочно-заданной функции должна быть функция calculate, "
        + "которая должна вычислять значение кусочно-заданной функции, а в модуле табулирования функция tabulate, "
        + "которая должна табулировать кусочно-заданную функцию."
    )
    document.add_paragraph(
        "В функции tabulate должно выполняться создание документа Microsoft Word и рабочей книги Microsoft Excel. "
        + "В созданный документ программа должна записывать задание, результаты работы программы (JPEG-изображение), "
        + "а также таблицу с результатами табулирования функции. В рабочую книгу требуется записать результаты "
        + "табулирования функции. Результаты табулирования также следует вывести в стандартный поток вывода. "
        + "В конце функции необходимо считать созданную рабочую книгу и вывести значения, записанные в её ячейках "
        + "в стандартный поток вывода."
    )
    document.add_paragraph(
        "В основной части программы следует реализовать ввод интервала табулирования и шага. "
        + "За ним должен следовать вызов функции tabulate."
    )
